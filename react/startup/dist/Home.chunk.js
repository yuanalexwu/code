...
/***/ function(module, exports, __webpack_require__) {
	...
	var _HomeStyle = __webpack_require__(796);
	...
	var _HomeAction = __webpack_require__(726);
	...
	var LOCATION_SAVE_TIMEOUT = 60; // 保存用户的位置坐标时间 单位秒
	...
	var Home = function (_Component) {
		...
		function Home(props) {
			...
			_this.initSwiper = function () {
				if (_this.state.swiper != undefined) {
					return false;
				}
			...
			_this.hanbdleInitSwiper = function () {
				if (window.Swiper === undefined) {
					var util = new _Util2.default();
					// swiper.js
					var jsPath = _config2.default.root_path + '/public/js/swiper.min.js';
					util.importJs(jsPath, function () {
						// js加载完成后操作
						// 初始化swiper 
						_this.initSwiper();
					});
					// swiper.css
					var cssPath = _config2.default.root_path + '/public/css/swiper.min.css';
			...
			_this.getCurrentWxLocation = function (quan) {
				_store2.default.dispatch((0, _CommonAction.commonUpdateLoading)(true));
				var latitude = '';
				var longitude = '';
				wx.getLocation({
					type: 'gcj02',
					success: function success(res) {
						...
						sessionStorage.setItem('timestamp', (0, _moment2.default)().format('X'));
						sessionStorage.setItem('lat', latitude);
						sessionStorage.setItem('lng', longitude);
						_this.props.homeGetNearbyMd(latitude, longitude, function () {
			...
			_this.handleQiang = function (quan, quanIsAvaiable) {
				var snackBar = void 0;
				if (!quanIsAvaiable) {
					// 需求只要能够看见的券都能抢
					snackBar = { open: true, message: '此券已经过期' };
					_store2.default.dispatch((0, _CommonAction.commonUpdateSnackBar)(snackBar));
					return false;
				}
	    ...
	    */
				...
				if (timestamp) {
					...
					if (timeDelta < LOCATION_SAVE_TIMEOUT) {
						_this.props.homeGetNearbyMd(lat, lng, function () {
							// 回调保存券id到state，显示选择提货站点
							_this.setState({
								quan_id: quan.Id,
								showMask: true
						...
						_this.getCurrentWxLocation(quan);
					}
				} else {
					_this.getCurrentWxLocation(quan);
				}
			...
			_this.handleDoQiang = function () {
				var quan_id = _this.state.quan_id;
				var md_id = _this.state.selectedMd;
				if (md_id == '0') {
					var snackBar = { open: true, message: "请选择一个提货站点" };
					_store2.default.dispatch((0, _CommonAction.commonUpdateSnackBar)(snackBar));
					return false;
				}
				_this.setState({
				...
				_this.props.homeDoQiang(quan_id, md_id);
			};

			_this.handleSelectMd = function (event, index, value) {
				_this.setState({
					selectedMd: value
				});
			};

			_this.handleCloseSelectMd = function () {
				_this.setState({
					showMask: false
				});
			};

			_this.handleCloseQuan = function () {
				_store2.default.dispatch((0, _HomeAction.homeUpdateShowQuan)(false));
			};
		...
		_createClass(Home, [{
			...
			value: function shouldComponentUpdate(nextProps, nextState) {
				...
				if (home.equals(nextProps.home) && this.state.showMask == nextState.showMask && this.state.selectedMd == nextState.selectedMd) {
					return false;
				}
				return true;
			}
			...
			value: function handleSliderClick(url) {
	   ...
	   */
			...
			value: function render() {
				...
				var quans = home.get('quans');
				var mds = home.get('mds') || _immutable2.default.fromJS([]);
				var quan = home.get('quan') || _immutable2.default.fromJS({});
				var showQuan = home.get('showQuan') || false;

				home = home.toJS();
				var _home = home,
				    sliders = _home.sliders;

				var sliderHtml = sliders.map(function (slider) {
					return _react2.default.createElement(
						'div',
						{ className: 'swiper-slide', key: slider.Id },
						_react2.default.createElement('img', { src: slider.img, style: _HomeStyle2.default.slider, onClick: _this2.handleSliderClick.bind(_this2, slider.url) })
					);
				});

				// 选择站点对话框
				mds = mds.toJS();
				var mdsHtml = mds.map(function (md, idx) {
					var distance = parseInt(md.juli); // 米
					if (distance < 1000) {
						distance = distance + '\u7C73';
					} else {
					...
					var text = md.name + '(' + distance + ')';
					return _react2.default.createElement(_MenuItem2.default, { value: md.Id, primaryText: text, key: idx });
				});
				var prefixHtml = _react2.default.createElement(_MenuItem2.default, { value: '0', primaryText: '\u8BF7\u9009\u62E9\u95E8\u5E97', key: 'a' });
				mdsHtml = _lodash2.default.concat([prefixHtml], mdsHtml);

				// 弹出抢到的优惠券
				quan = quan.toJS();

				var selectMdActions = [_react2.default.createElement(_RaisedButton2.default, {
					label: '\u62A2\u8D2D',
					secondary: true,
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'swiper-container', style: _HomeStyle2.default.swiperWrapper },
						_react2.default.createElement(
							'div',
					...
					_react2.default.createElement(
						'div',
						{ className: 'displayFlex justifyContentCenter alignItemCenter', style: _HomeStyle2.default.headTitle },
						'\u4F18\u60E0\u5238'
					),
					_react2.default.createElement(_QuanList2.default, { origin: _RouterMap2.default.Home, quans: quans, qiangFn: this.handleQiang }),
					_react2.default.createElement(_RedirectButton2.default, { name: '\u6211\u7684\u5238', path: '/UserCenter' }),
					_react2.default.createElement(
						_Dialog2.default,
						{
							title: '\u9009\u62E9\u63D0\u8D27\u95E8\u5E97',
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement('img', { style: { width: '100%' }, src: _config2.default.root_path + '/barcode/test.php?codebar=BCGcode128&text=' + quan.no })
						)
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var styles = {
		...
		headTitle: {
			...
			height: '4rem',
			background: white,
			color: _GlobalStyle2.default.FrontColor,
			borderBottom: '.2rem solid ' + _GlobalStyle2.default.FrontColor,
			display: 'flex',
