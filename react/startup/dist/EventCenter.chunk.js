...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventCenterStyle = __webpack_require__(818);

	var _EventCenterStyle2 = _interopRequireDefault(_EventCenterStyle);
	...
	var _EventItem = __webpack_require__(819);
	...
	var EventCenter = function (_Component) {
		_inherits(EventCenter, _Component);

		function EventCenter(props) {
			_classCallCheck(this, EventCenter);

			var _this = _possibleConstructorReturn(this, (EventCenter.__proto__ || Object.getPrototypeOf(EventCenter)).call(this, props));
		...
		_createClass(EventCenter, [{
			...
			value: function render() {
				...
				eventCenter = eventCenter ? eventCenter : _immutable2.default.fromJS([]);
				eventCenter = eventCenter.toJS();
				var eventHtml = eventCenter.map(function (event, idx) {
					return _react2.default.createElement(_EventItem2.default, { key: idx, item: event });
				});

				var head_img_src = _config2.default.root_path + '/public/img/event_head.jpg';
				var qrcode_img_src = _config2.default.root_path + '/public/img/event_qrcode.jpg';

				return _react2.default.createElement(
					'div',
					{ style: _EventCenterStyle2.default.eventImg },
					_react2.default.createElement('img', { src: head_img_src, style: _EventCenterStyle2.default.head }),
					_react2.default.createElement(
						'div',
						{ style: { width: '100%', textAlign: 'center', background: 'white', paddingBottom: '1rem', fontSize: '1.8rem' } },
						_react2.default.createElement('img', { src: qrcode_img_src, style: _EventCenterStyle2.default.qrcode }),
						_react2.default.createElement(
							'div',
							{ style: _EventCenterStyle2.default.qrcode_info },
							'\u626B\u7801\u5173\u6CE8\u5BB6\u6613\u4E50\u5BA2\u670D\u670D\u52A1\u4E8C\u7EF4\u7801'
						),
						_react2.default.createElement(
							'div',
					...
					_react2.default.createElement(
						'div',
						{ style: _EventCenterStyle2.default.contentWrapper },
						_react2.default.createElement(
							'div',
							{ style: _EventCenterStyle2.default.contentInner },
							eventHtml
						)
					),
					_react2.default.createElement(_RedirectButton2.default, { name: '\u8BA2\u5355', path: '/UserCenter' })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventItemStyle = __webpack_require__(820);

	var _EventItemStyle2 = _interopRequireDefault(_EventItemStyle);
	...
	var _Counter = __webpack_require__(821);
	...
	var EventItem = (_temp = _class = function (_Component) {
		...
		function EventItem(props) {
			...
			_this.changeEventItemState = function () {
				_this.setState({
					re_render: true
				});
			};

			_this.parseTitle = function (datetime) {
				var timeObj = (0, _moment2.default)(datetime, "YYYY-MM-DD HH-mm-ss");
				var month = timeObj.format("MM");
				var day = timeObj.format("DD");
				return '\u5230' + month + '\u6708' + day + '\u6D3B\u52A8\u622A\u6B62';
			};

			_this.eventIsGoingOn = function (datetime) {
				var isGoingOn = true;
				var now_timestamp = (0, _moment2.default)().format('X');
				var end_timestamp = (0, _moment2.default)(datetime, "YYYY-MM-DD HH-mm-ss").format('X');
	  ...
	  */
		...
		_createClass(EventItem, [{
			key: 'shouldComponentUpdate',
			value: function shouldComponentUpdate(nextPorps, nextState) {
				if (_immutable2.default.fromJS(nextPorps).equals(_immutable2.default.fromJS(this.props)) && _immutable2.default.fromJS(nextState).equals(_immutable2.default.fromJS(this.state))) {
					return false;
				}
				return true;
			}
			...
			value: function render() {
				...
				var e_time = item.e_time;

				var end_title = this.parseTitle(e_time);
				// 活动进行中
				var bottomHtml = void 0;
				var soldoutMaskHtml = void 0;
				var corner_img = "event_corner_end.png";
				if (this.eventIsGoingOn(e_time)) {
					corner_img = "event_corner.png";
					bottomHtml = _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(
							'div',
							{ style: _EventItemStyle2.default.title },
							'\xA0',
							end_title
						),
						_react2.default.createElement(
							'div',
							{ style: _EventItemStyle2.default.counter },
							_react2.default.createElement(_Counter2.default, { datetime: item.e_time }),
							'\xA0'
						)
					);
				} else {
					bottomHtml = _react2.default.createElement(
						'div',
						{ style: _EventItemStyle2.default.bottomEndFont },
						'\u6D3B\u52A8\u622A\u6B62'
					);

					var mask_img_src = _config2.default.root_path + '/public/img/event_soldout_mask.png';
					soldoutMaskHtml = _react2.default.createElement('img', { src: mask_img_src, style: _EventItemStyle2.default.soldoutMask, onClick: this.handleClick });
				}
				var corner_img_src = _config2.default.root_path + '/public/img/' + corner_img;

				// 商品是否售罄
				if (soldoutMaskHtml === undefined && item.state == 2) {
					var _mask_img_src = _config2.default.root_path + '/public/img/event_soldout_mask.png';
					soldoutMaskHtml = _react2.default.createElement('img', { src: _mask_img_src, style: _EventItemStyle2.default.soldoutMask, onClick: this.handleClick });
				}
				return _react2.default.createElement(
					'div',
					{ style: _EventItemStyle2.default.wrapper },
					_react2.default.createElement(
						'div',
						{ style: _EventItemStyle2.default.imgWrapper },
						soldoutMaskHtml,
						_react2.default.createElement('img', { src: corner_img_src, style: _EventItemStyle2.default.corner }),
						_react2.default.createElement('img', { src: '' + _config2.default.img_path + item.pic_url, style: _EventItemStyle2.default.img, onClick: this.handleClick })
					),
					bottomHtml
				);
			}
		...
		changeEventItemState: _react.PropTypes.func
	}, _temp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Counter = (_temp = _class = function (_Component) {
	   ...
	   */
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ style: _EventItemStyle2.default.counterWrapper },
					'\u5269\u4F59',
					_react2.default.createElement(
						'span',
						{ style: _EventItemStyle2.default.counterTimerWrapper },
						_react2.default.createElement(
							'span',
							{ style: _EventItemStyle2.default.counterTimeFont },
							day
						)
					),
					'\u5929',
		...
		this.parseTime = function (timedelta) {
			var hours = Math.floor(timedelta / 3600);
			var day = Math.floor(hours / 24);
			var hour = hours % 24;
			var minute = Math.floor((timedelta - hours * 3600) / 60);
			var second = timedelta % 60;
			// beautify
			day = '' + day;
			hour = '' + hour;
			minute = '' + minute;
		...
		this.updateTime = function () {
			...
			_this2.interval = setInterval(function () {
				now = parseInt((0, _moment2.default)().format('X'));
				var datetime = parseInt((0, _moment2.default)(_this2.state.datetime, "YYYY-MM-DD HH:mm:ss").format('X'));
				if (now >= datetime) {
					_this2.setState({
						day: '00',
						hour: '00',
					...
					_this2.context.changeEventItemState();
				} else {
					var timedelta = datetime - now;
					var leftTime = _this2.parseTime(timedelta);
					_this2.setState({
						day: leftTime.day,
						hour: leftTime.hour,
